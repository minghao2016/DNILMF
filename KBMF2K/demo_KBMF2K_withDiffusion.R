...
# 2016-10-19: for producing array
numDrug <- nrow(sd)
numTarget <- nrow(st)
...
cat(
  ...
  "\n=====================\n")
cat(numSplit, "trails of 10-fold CV", "\n")
cat("KBMF2K: with diffusion kernels \n")
...
savedFileName <- paste0(db, "-", "KBMF2K", "-", "runDiffusion", "-", runDiffusion, "-", curDate, "_", curTime, ".RData")
cat("\n\n")
print(savedFileName)
